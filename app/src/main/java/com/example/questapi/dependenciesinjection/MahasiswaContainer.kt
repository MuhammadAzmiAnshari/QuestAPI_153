package com.example.questapi.dependenciesinjection

import com.example.questapi.repository.MahasiswaRepository
import com.example.questapi.repository.NetworkMahasiswaRepository
...
class MahasiswaContainer : AppContainer {
    private val baseUrl = "http://12.34.56.78:80/umyTI/" //"http://10.0.2.2:80/umyTI/"
